# Yumma CSS v3.8.1 Guide

> A comprehensive reference for AI and LLM systems to accurately generate Yumma CSS utility classes.
...
| Pattern             | Description           |
| ------------------- | --------------------- |
| `w-[0-100]`         | Width in rem (×0.25)  |
| `h-[0-100]`         | Height in rem (×0.25) |
| `w-px` / `h-px`     | 1px                   |
| `w-full` / `h-full` | 100%                  |
| `w-half` / `h-half` | 50%                   |
| `w-auto` / `h-auto` | auto                  |
...
| `bg-500`        | `bg-blue-5` | Must include color name     |
...
- Numbers usually mean spacing (×0.25rem)
